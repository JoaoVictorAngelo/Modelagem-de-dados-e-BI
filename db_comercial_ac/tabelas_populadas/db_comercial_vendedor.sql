...
CREATE TABLE `vendedor` (
  ...
  UNIQUE KEY `telefone_vendedor` (`telefone_vendedor`),
  UNIQUE KEY `email` (`email`),
  CONSTRAINT `chk_vendedor_nome` CHECK ((length(`nome_vendedor`) > 0))
...
INSERT INTO `vendedor` VALUES (1,'Ricardo Alves','11987654321','ricardo.alves@empresa.com'),(2,'PatrÃ­cia Souza','11912345678','patricia.souza@empresa.com');
